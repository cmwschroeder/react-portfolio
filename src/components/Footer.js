    ...
    return (
        <footer className="footer items-center p-4 text-neutral-content bg-base-300">
            ...
            <div className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
                <a href="https://github.com/cmwschroeder" target="_blank" rel="noreferrer"><svg fill="#ffffff" xmlns="http://www.w3.org/2000/svg"
                ...
                <a href="https://www.linkedin.com/in/christian-schroeder1/" target="_blank" rel="noreferrer"><svg
